...
import {FileUploadHandler, RefreshTokenService} from './types';
...
export namespace TokenServiceConstants {
  export const TOKEN_SECRET_VALUE = 'K@I$@KKU%*&C@l1';
...
export namespace UserServiceBindings {
  ...
  export const DATASOURCE_NAME = 'fdesjwtdb';
...
export namespace RefreshTokenConstants {
   ...
   */
  export const REFRESH_SECRET_VALUE = 'fdesr3fr35htok3nKaisaku';
  /**
   ...
   */
  export const REFRESH_ISSUER_VALUE = 'fdesrefresh';
}
...
export namespace RefreshTokenServiceBindings {
   ...
   */
  export const DATASOURCE_NAME = 'fdesrefreshdb';
  /**
